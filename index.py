...
def flat_map(document):
    ...
    """
    """ Your code here. """
    mylst = re.findall(r"\w+", document[1])
    copy = mylst
    my3lst = re.findall(r"\w+", document[0])
    my2lst=[]
    for elem in copy:
        my2lst.append(copy.index(elem))
        copy[copy.index(elem)] = " "
    return (mylst, my2lst, my3lst)
